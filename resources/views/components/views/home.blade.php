...
<div class="w-full px-8">
    <div class="max-w-2xl mt-4 mx-auto shadow-lg rounded-md">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-0">
            ...
            <!-- Menu lainnya -->
            <div class="text-center bg-footer py-5 rounded-md hover:bg-kirim"><a href="#">Peminjaman</a></div>
            <div class="text-center bg-footer py-5 rounded-md hover:bg-kirim"><a href="#">Pembayaran</a></div>
            <div class="text-center bg-footer py-5 rounded-md hover:bg-kirim"><a href="#">Penarikan</a></div>
        </div>
    </div>
</div>
