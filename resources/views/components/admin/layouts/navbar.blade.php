<nav class="fixed z-30 w-full text-black  bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="https://flowbite-admin-dashboard.vercel.app/" class="flex ml-2 md:mr-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-black dark:text-white">Koperasi
                        Merah Putih</span>
                </a>
