                ...
                <div
                    ...
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            <a href="/dashboard"
                                ...
                                <span class="ml-3" sidebar-toggle-item>Dashboard Menu</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap font-bold"
                                    sidebar-toggle-item>Peminjaman</span>
                                <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            <ul id="dropdown-peminjaman" class="space-y-2 py-2 hidden ">
                                <li>
                                    <a href="/das/peminjaman"
                                        class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">All</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <button type="button"
                                class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                aria-controls="dropdown-nasabah" data-collapse-toggle="dropdown-nasabah">
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap font-bold"
                                    sidebar-toggle-item>Nasabah</span>
                                <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            <ul id="dropdown-nasabah" class="space-y-2 py-2 hidden ">
                                <li>
                                    <a href="/nasabah"
                                        class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">All</a>
                                </li>
                                <li>
                                    <a href="/das/nasabah/bermasalah"
                                        class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Nasabah
                                        Bermasalah</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="pt-2 space-y-2">
                        ...
                        <a href="https://github.com/themesberg/flowbite-admin-dashboard" target="_blank"
                            ...
                            <span class="ml-1" sidebar-toggle-item>OTHER</span>
                        </a>
                        <a href="/das/usaha" target="_blank"
                            class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
