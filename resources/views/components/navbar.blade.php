<div>
    <nav class="bg-footer" x-data="{ isOpen: false }">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0 flex flex-col items-start md:flex-row md:items-center">
                        <img src={{ asset('img/logo.png') }} alt="Your Company" class="size-8" />
                        <span class="text-white">Koperasi Simpan Pinjam </span> <span></span>
                        <span class="text-white">Desa Gajah</span>
                    </div>
                </div>
                <div class="ml-auto hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="#about us" :active="request()->is('#about us')">Tentang</x-nav-link>
                        <x-nav-link href="/usaha/detail" :active="request()->is('usaha/detail')">Usaha</x-nav-link>
        ...
        <div x-show="isOpen" id="mobil  e-menu" class="md:hidden">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                            alt="" class="size-10 rounded-full aspect-square object-cover" />
                    </div>
                    <div class="ml-3">
