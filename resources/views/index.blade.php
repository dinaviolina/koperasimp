...
<body class="h-full">
    ...
    <section id="about us" class="relative w-full z-20 py-8 overflow-hidden bg-white">
        ...
        <div class=" xl:w-10/12 mx-auto relative">
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 z-20 ">
                <img class="object-cover object-top w-1/2 sm:h-72 md:h-96 lg:w-1/2 lg:h-full"
                    src="{{ asset('img/about.png') }}" alt="foto about">
            </div>
        </div>
    </section>
    {{-- end about us --}}
    <section id="usaha" class="text-gray-700 body-font mt-10">
        ...
        <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                ...
                @endforeach
                @if ($usaha->count() == 0)
                    <p class="text-center text-gray-500 col-span-3">No Usaha Found.</p>
                @endif
    ...
    <section class="bg-gray-100">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-20 lg:px-8">
            <div class="max-w-2xl lg:max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-extrabold text-gray-900" id="contactUs">Kunjungi Lokasi Kami</h2>
                <p class="mt-3 text-lg text-gray-500">Kami akan melayani Anda dengan sepenuh hati</p>
            </div>
            <div class="mt-8 lg:mt-20">
                    ...
                    <div>
                        <div class="max-w-full mx-auto rounded-lg overflow-hidden">
                            <div class="border-t border-gray-200 px-6 py-4">
                                ...
                                <p class="mt-1 font-bold text-gray-600"><a href="tel:+123">Telephon: +91
                                        123456789</a></p>
                ...
                1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                            ...
                            <div class="px-6 py-4">
                                ...
                                <p class="mt-1 text-gray-600">Gajah, Baureno</p>
                            </div>
                            <div class="border-t border-gray-200 px-6 py-4">
                                <h3 class="text-lg font-medium text-gray-900">Jam Operasional</h3>
                                <p class="mt-1 text-gray-600">Senin - Minggu : 8 pagi - 9 malam</p>
                            </div>
                        </div>
                    </div>
