...
<head>
    ...
    <title>
        Stocks Dashboard | TailAdmin - Tailwind CSS Admin Dashboard Template
    </title>
    <link rel="icon" href="favicon.ico">
    <link href="style.css" rel="stylesheet">
    <script data-cfasync="false" nonce="b8d776dc-2159-4af3-968a-6229104d91b0">
        try {
            (function(w, d) {
                ! function(fv, fw, fx, fy) {
                    if (fv.zaraz) console.error("zaraz is loaded twice");
                        ...
                        fv.zaraz._v = "5858";
                        fv.zaraz._n = "b8d776dc-2159-4af3-968a-6229104d91b0";
                        fv.zaraz.q = [];
...
<body x-data="{ page: 'stocks', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
                            ...
                            <li>
                                ...
                                <div class="translate transform overflow-hidden"
                                    ...
                                    <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                                        class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                        <li>
                                            <a href="ai-text-generator.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="ai-image-generator.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="ai-code-generator.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="ai-video-generator.html" class="menu-dropdown-item group"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="data-tables.html" class="menu-dropdown-item group"
                                                ...
                                                Data Tables
                                                <span class="absolute right-3 flex items-center gap-1">
                                                    <span class="menu-dropdown-badge-pro"
                                                        :class="page === 'dataTables' ? 'menu-dropdown-badge-pro-active' :
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="line-chart.html" class="menu-dropdown-item group"
                                                ...
                                                <span class="absolute right-3 flex items-center gap-1">
                                                    <span class="menu-dropdown-badge-pro"
                                                        :class="page === 'lineChart' ? 'menu-dropdown-badge-pro-active' :
                                                            'menu-dropdown-badge-pro-inactive'">
                                                        Pro
                                                    </span>
                                                </span>
                                        ...
                                        <li>
                                            <a href="bar-chart.html" class="menu-dropdown-item group"
                                                ...
                                                <span class="absolute right-3 flex items-center gap-1">
                                                    <span class="menu-dropdown-badge-pro"
                                                        :class="page === 'barChart' ? 'menu-dropdown-badge-pro-active' :
                                                            'menu-dropdown-badge-pro-inactive'">
                                                        Pro
                                                    </span>
                                                </span>
                                        ...
                                        <li>
                                            <a href="pie-chart.html" class="menu-dropdown-item group"
                                                ...
                                                <span class="absolute right-3 flex items-center gap-1">
                                                    <span class="menu-dropdown-badge-pro"
                                                        :class="page === 'pieChart' ? 'menu-dropdown-badge-pro-active' :
                                                            'menu-dropdown-badge-pro-inactive'">
                                                        Pro
                                                    </span>
                                                </span>
                                ...
                                <div>
                                    ...
                                    <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
                                        <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                            data-cfemail="4436252a202b293137213604342d292e2b6a272b29">[email&#160;protected]</a>
                                    </span>
                                </div>
                    ...
                    <div class="grid grid-cols-12 gap-4 md:gap-6">
                                ...
                                <div
                                    ...
                                    <div class="flex items-end justify-between">
                                        ...
                                        <span
                                            ...
                                            <svg class="fill-current" width="13" height="12"
                        ...
                        <div class="col-span-12 space-y-6 xl:col-span-8">
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div x-data="{ selected: 'optionOne' }"
                                        ...
                                        <button @click="selected = 'optionOne'"
                                            ...
                                            class="px-3 py-2 font-medium transition-colors rounded-md text-theme-sm hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white">
                                            Monthly
                                        </button>
                                ...
                                <div class="max-w-full overflow-x-auto custom-scrollbar">
                                    <div id="chartFourteen" class="-ml-4 min-w-[900px] pl-2 xl:min-w-full"></div>
                                </div>
                            </div>
                            <!-- ====== Chart Fourteen End -->
                                    ...
                                    <div class="stocks-slider-outer relative flex items-center gap-1.5">
                                        <div class="swiper-button-prev">
                                            <svg class="stroke-current" width="16" height="16"
                                                ...
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.1667 4L6 8.16667L10.1667 12.3333" stroke=""
                                        ...
                                        <div class="swiper-button-next">
                                            <svg class="stroke-current" width="16" height="16"
                                                viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.83333 12.6667L10 8.50002L5.83333 4.33335" stroke=""
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                            ...
                                            <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10">
                                                            <img src="src/images/brand/brand-09.svg"
                                                                alt="brand" />
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            ...
                                                            <svg class="fill-current" width="12"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10">
                                                            <img src="src/images/brand/brand-07.svg"
                                                                alt="brand" />
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10">
                                                            <img src="src/images/brand/brand-11.svg"
                                                                alt="brand" />
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10">
                                                            <img src="src/images/brand/brand-08.svg"
                                                                alt="brand" />
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10">
                                                            <img src="src/images/brand/brand-10.svg"
                                                                alt="brand" />
                                                        </div>
                                ...
                                <div class="flex h-[372px] flex-col">
                                    <div class="custom-scrollbar flex h-auto flex-col overflow-y-auto pr-3">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="h-10 w-10">
                                                    <img src="src/images/brand/brand-12.svg" alt="brand" />
                                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="h-10 w-10">
                                                    <img src="src/images/brand/brand-13.svg" alt="brand" />
                                                </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <div
                                ...
                                <div
                                    class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
                                    <table class="min-w-full">
                                        <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                                            ...
                                            <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-theme-sm text-gray-500 dark:text-gray-400">Price
                                                    </p>
                                                </div>
                                            </th>
                                            <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                            ...
                                            <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-theme-sm text-gray-500 dark:text-gray-400">Status
                                                    </p>
                                                </div>
                                            </th>
                                        </thead>
                                            ...
                                            <tr>
                                                <td class="py-3 pr-5 whitespace-nowrap sm:pr-6">
                                                    <div class="flex items-center">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-8 w-8">
                                                                <img src="src/images/brand/brand-15.svg"
                                                                    alt="brand" />
                                                            </div>
                                            ...
                                            <tr>
                                                <td class="py-3 pr-5 whitespace-nowrap sm:pr-6">
                                                    <div class="flex items-center">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-8 w-8">
                                                                <img src="src/images/brand/brand-02.svg"
                                                                    alt="brand" />
                                                            </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        ...
        data-cf-beacon='{"rayId":"966a97e6cd3a34c9","version":"2025.7.0","r":1,"token":"67f7a278e3374824ae6dd92295d38f77","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}'
