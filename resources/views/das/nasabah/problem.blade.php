...
<body class="bg-gray-50 dark:bg-gray-800 min-h-screen flex flex-col">
        ...
        <main class="flex-grow ">
            ...
            <div class="px-6 pt-6">
                <div class="mb-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Nasabah Bermasalah</h1>
                </div>
                <div class="sm:flex">
                    <div
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto dark:divide-gray-600">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div> Tervalidasi
                                    </div>
                                </td>
    ...
    </main> --}} <footer><x-admin.footer></x-admin.footer>
    </footer>
