...
<body class="bg-gray-50 dark:bg-gray-800 min-h-screen flex flex-col">
    ...
    <div class=" mt-6 ">
        ...
        <table class="min-w-full divide-y bg-white divide-gray-200 table-auto ">
            ...
            <tbody>
                @forelse ($penarikan as $pnrkn)
                    <tr>
                        <td class="p-4 text-xs font-medium text-left text-gray-500  "> {{ $loop->iteration }}
                        </td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  "><a
                                href="">{{ $pnrkn->nasabah->kode_nasabah }}</a>
                        </td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  "> Rp
                            {{ $pnrkn->simpanan->jumlah_simpanan }}</td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  ">Rp {{ $pnrkn->jumlah_penarikan }}
                        </td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  ">{{ $pnrkn->status_penarikan }}
                        </td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  ">{{ $pnrkn->created_at }}</td>
                        <td class="p-4 text-sm font-medium text-left text-gray-500  ">{{ $pnrkn->updated_at }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="p-4 text-sm font-medium text-center text-gray-500  ">
                            No data available
                        </td>
                    </tr>
                @endforelse
