...
<body class="bg-gray-50 dark:bg-gray-800 min-h-screen flex flex-col">
    ...
    <div id="main-content" class=" relative w-max-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
        <main class="flex-grow">
            <div class="px-4 pt-8 mb-5">
                {{-- grid 3 --}}
                <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3">
                    <div
                        class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="w-full">
                            <h3 class="text-base font-bold text-gray-500 dark:text-gray-400">Jumlah Nasabah
                            </h3>
                            ...
                            <p class="flex items-center text-base font-normal text-gray-500 dark:text-gray-400">
                                <span class="flex items-center mr-1.5 text-sm text-green-500 dark:text-green-400">
                                    ...
                                    @if (isset($nasabah))
                                        Aktif : {{ $nasabah->where('status', 'aktif')->count() }} Tidak Aktif :
                                        {{ $nasabah->where('status', 'tidak aktif')->count() }}
                                    @else
                    ...
                    <div
                        class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="w-full">
                            <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Jumlah Simpanan</h3>
                            <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
                                @if (isset($simpanan))
                                    Rp. {{ number_format($simpanan->sum('jumlah'), 0, ',', '.') }}
                                @else
                                    Rp. 0
                                @endif
                            </span>
