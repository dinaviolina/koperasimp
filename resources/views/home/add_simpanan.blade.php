<x-layout>
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="p-6 space-y-6">
            <form action="/simpanan" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-6 gap-6">

                    <div class="col-span-6 sm:col-span-3">
                        <label for="nasabah_id" class="text-sm font-medium text-gray-900 block mb-2">Kode
                            Nasabah</label>
                        <input type="text" name="nasabah_id" id="nasabah_id" value={{ $nasabah->kode_nasabah }}
                            readonly
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="kode_simpanan" class="text-sm font-medium text-gray-900 block mb-2">Kode
                            Simpanan</label>
                        <input type="text" name="kode_simpanan" id="kode_simpanan" readonly
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                            placeholder="Electronics">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="status" class="text-sm font-medium text-gray-900 block mb-2">Status</label>
                        <input type="text" name="status" id="status" value="diajukan"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                            placeholder="Electronics">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="jumlah_simpanan" id="jumlah_simpanan"
                            ...
                            placeholder="Masukkan jumlah simpanan Rp ">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="jenis_simpanan" class="text-sm font-medium text-gray-900 block mb-2">Jenis
                            Simpanan</label>
                        <select name="jenis_simpanan" id="jenis_simpanan"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5
                            form-control @error('jenis_simpanan') is-invalid
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="bukti_simpanan" class="text-sm font-medium text-gray-900 block mb-2">Bukti
                            Simpanan </label>
                        <input type="file" name="bukti_simpanan" id="bukti_simpanan"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5
                            form-control @error('bukti_simpanan')
                                is-invalid
                            @enderror"
                            required="">
                        ...
                        @enderror
                        <span class="text-xs">*upload screenshot bukti transfer / foto penyerahan</span>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 rounded-b flex justify-start gap-2">
                    <button
